...
import static com.prieds.rfidlibrary.BaseApplication.SHOW_HISTORY_CONNECTED_LIST;
...
import com.prieds.rfidlibrary.R;
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if(!TextUtils.isEmpty(address)) {
                ...
                BaseApplication.showToast(getResources().getString(R.string.invalid_bluetooth_address));
            }
        }
    };
