...
package com.prieds.rfidlibrary.bluetooth;
...
import com.prieds.app.BaseActivity;
import com.prieds.app.R;
import com.prieds.app.ui.stock.rfid.ScanRfidActivity;
...
public class DeviceListActivity extends BaseActivity {
    ...
    private void init() {
        ...
        boolean isHistoryList = getIntent().getBooleanExtra(ScanRfidActivity.SHOW_HISTORY_CONNECTED_LIST, false);
        if (isHistoryList) {
